...
description: Review uncommitted JavaScript/TypeScript, React, and Next.js changes against a language, React, Next.js, and testing checklist and provide a prioritized report.
