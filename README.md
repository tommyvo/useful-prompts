...
| security-review-checklist | Deep security review of uncommitted changes: application (OWASP/business logic), secrets, supply chain, Terraform/Atmos on AWS, CI/CD, and optional SOC 2/GDPR data handling; suggests scanners | [Prompt File](<./Github Copilot/Prompt Files/security-review-checklist.prompt.md>) | [Skill](<./Cursor/Skills/security-review-checklist/SKILL.md>) | [Skill](<./Claude Code/Skills/security-review-checklist/SKILL.md>) | [Command](./opencode/command/security-review-checklist.md) |
| gh-pr-security-review-checklist | Deep security review of a GitHub PR against the same checklists, using the `gh` CLI | [Prompt File](<./Github Copilot/Prompt Files/gh-pr-security-review-checklist.prompt.md>) | [Skill](<./Cursor/Skills/gh-pr-security-review-checklist/SKILL.md>) | [Skill](<./Claude Code/Skills/gh-pr-security-review-checklist/SKILL.md>) | [Command](./opencode/command/gh-pr-security-review-checklist.md) |
...
| `/security-review-checklist` | Security review of uncommitted changes (optionally with `soc2` / `gdpr`) |
| `/gh-pr-security-review-checklist` | Security review of a GitHub PR (optionally with `soc2` / `gdpr`) |
